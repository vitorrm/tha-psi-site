    ...
    <div class="container mx-auto flex justify-between items-center py-6 px-5">
      ...
      >
        <svg
          ...
          class="w-10 h-10 text-white p-2 bg-gradient-to-br from-pink-500 to-yellow-500 rounded-full"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <span class="ml-3 text-xl text-gray-100 font-semibold antialiased"
          >Navbar 1</span
        >
      </a>
      ...
      <div
        class="hidden sm:inline-flex ml-auto md:ml-0 mr-4 md:mr-0 cursor-pointer"
      >
        <svg
          class="h-8 w-8"
          xmlns="http://www.w3.org/2000/svg"
