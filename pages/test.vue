      ...
      >
        <div id="pageintro" class="hoc clear">
          ...
          <article>
            ...
            <p>
              In nibh nullam egestas velit laoreet nullam elementum ipsum
              pharetra suscipit leo augue pretium felis nisl vitae ipsum
              curabitur quis libero.
            </p>
          ...
          <ul class="nospace group elements elements-three">
            ...
            <li class="one_third">
              <article>
                ...
                <p>
                  Urna proin venenatis eros viverra ultrices fringilla lectus
                  urna consequat erat eget scelerisque ligula felis nec neque
                  nam.
                </p>
              </article>
            </li>
            ...
            <li class="one_third">
              <article>
                ...
                <p>
                  Pede turpis at elit nunc at urna sed ligula vivamus vel erat
                  at diam imperdiet pharetra quisque justo turpis mattis ut
                  vitae.
                </p>
              </article>
            </li>
            <li class="one_third">
              <article>
                ...
                <p>
                  ...
                  risus proin risus nibh viverra eget lobortis feugiat egestas
                  in nisl.
                </p>
              </article>
            </li>
            <li class="one_third">
              <article>
                ...
                <p>
                  Fusce dignissim neque vitae justo aenean ac urna et leo
                  posuere pretium nunc bibendum enim quis imperdiet elementum
                  dui dolor.
                </p>
              </article>
            </li>
      ...
      <div class="wrapper coloured">
        <section id="testimonials" class="hoc container clear">
          ...
          <article class="one_half first">
            ...
            <blockquote>
              Pulvinar tortor quis nisi in hac habitasse platea dictumst donec
              ac tellus fusce venenatis laoreet elit sed est tortor molestie in
          ...
          <article class="one_half">
            ...
            <blockquote>
              Orci vitae dolor scelerisque blandit morbi eu dui sed volutpat
              etiam leo leo bibendum vel dictum sed sollicitudin a mi
              pellentesque ligula nulla facilisi sed bibendum ornare.
            </blockquote>
          </article>
          <!-- ################################################################################################ -->
        </section>
        ...
        <section id="ctdetails" class="hoc container clear">
          ...
          <article class="one_half">
            ...
            <p class="nospace btmspace-15">
              ...
              justo magna odio sed lacus ut non ante sit amet est luctus dictum
              ut dolor ac.
            </p>
              ...
              <li>
                <article>
                  <p class="nospace btmspace-10">
                    <a href="#"
                      >Lacinia donec tortor lectus varius vel egestas a dictum
                      in odio mauris metus.</a
                    >
                  </p>
